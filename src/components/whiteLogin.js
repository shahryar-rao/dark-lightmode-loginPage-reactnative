...
const WhiteLogin = () => {
  ...
  //   'roboto': require('./assets/fonts/Roboto-Bold.ttf'), // Add other fonts here if needed
  // });
    ...
    <SafeAreaView style={styles.containerImage} >
      <View style={styles.imageContainer}>
        <View style={styles.logoContainer}>
          <View style={styles.row}>
            <Image source={require('../../assets/TheTolet.png')} style={styles.logo} />
        ...
        <Image source={require('../../assets/Subtract.png')} style={styles.Image} />
      </View>
      <View style={styles.container}>
        ...
        <TextInput
          ...
          />
        <View style={{flexDirection:'row', borderBottomWidth:2, borderBlockColor:'#000113', width:'92%',}}>
